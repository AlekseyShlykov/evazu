...
export const translations = {
  en: {
    ...
    illustrationProjectTitles: [
      ...
      'Editorial illustrations for Media 226',
    ...
    about: {
      tagline: 'Illustrator, 2D Animator, Graphic Designer. Currently based in France.',
  ...
  fr: {
    ...
    about: {
      tagline: 'Illustratrice, Animatrice 2D, Graphiste. Actuellement basée en France.',
