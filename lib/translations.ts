...
export const translations = {
  en: {
    ...
    contact: {
      ...
      formMessagePlaceholder: 'Tell me about your project, timeline, or anything you would like to discuss.',
      formSend: 'Send',
      formSending: 'Sending…',
  ...
  ru: {
    ...
    contact: {
      ...
      formMessagePlaceholder: 'Расскажите о проекте, сроках или чём угодно, что хотите обсудить.',
      formSend: 'Отправить',
  ...
  fr: {
    ...
    contact: {
      ...
      formMessageLabel: 'Message',
      formMessagePlaceholder: 'Parlez-moi de votre projet, des délais ou de ce que vous souhaitez aborder.',
      formSend: 'Envoyer',
      formSending: 'Envoi…',
